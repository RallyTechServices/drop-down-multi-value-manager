...
from techservices.ValueManager import ValueManager
...
if __name__ == "__main__":
    ...
    logfile_name = config['log_filename']
    
    # Set up logging
    with open(logfile_name, "r", encoding="utf-8") as fd:
    ...
    manager = ValueManager(rally, preview=False)
...
class ValueManager:
    ...
    def __init__(self, rally, preview = True):
        self.rally = rally
